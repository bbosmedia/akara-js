            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse">
                    ...
                    <div className="navbar-nav ya-opt-navbar align-items-center mr-0">
                        ...
                        <img loading="lazy" height="26" src="/images/search.svg" className="d-inline-block align-middle lazyLoad isLoaded" />
                        </a>
                        ...
                        <img loading="lazy" height="25" src="/images/ic_profile.d6b094d.svg" className="d-inline-block align-middle lazyLoad isLoaded" />
                        </a> 
                        <a href="#" className="nav-item nav-link ya-cart-icon border-left-0 pt-0 pb-0">
                        ...
                        <img loading="lazy" height="20" src="/images/menu_bar.svg" className="d-inline-block align-middle lazyLoad isLoaded" />
                        </a>
                    </div>
                </div>
            </div>
